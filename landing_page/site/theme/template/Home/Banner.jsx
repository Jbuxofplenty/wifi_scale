      ...
      <ScrollElement id="banner" className={`${this.props.className}-wrapper`}>
        ...
        <div className={this.props.className}>
          {!this.props.isMobile
            ...
            : <div className={`${this.props.className}-buffer`} />}
          <QueueAnim
            type="bottom"
          ...
          >
            ...
            <div key="button">
              <ScrollLink className={`${this.props.className}-text-button`} to="page1" showHeightActive={['100%', '30%']} toHash={false}>
          ...
          <TweenOne
            animation={{ opacity: 0, type: 'from', delay: 10 }}
