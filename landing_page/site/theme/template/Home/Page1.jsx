...
const page1 = [
  {
    title: <FormattedMessage id="app.home.fatures.interview" />,
    subtitle: <FormattedMessage id="app.home.fatures.subinterview" />,
    link: '',
    src: 'https://gw.alipayobjects.com/zos/rmsportal/QCcDSfdbCIbVSsUZJaQK.svg',
  },
  {
    title: <FormattedMessage id="app.home.fatures.mock" />,
    subtitle: <FormattedMessage id="app.home.fatures.submock" />,
    link: '',
    src: 'https://gw.alipayobjects.com/zos/rmsportal/hMSnSxMzmiGSSIXxFtNf.svg',
  },
  {
    title: <FormattedMessage id="app.home.fatures.offer" />,
    subtitle: <FormattedMessage id="app.home.fatures.suboffer" />,
    link: '',
...
export default class Page1 extends React.PureComponent {
      ...
      return (
        <Col md={8} xs={24} key={i.toString()} className="page1-item">
          ...
          >
            ...
            <div className="page1-item-subtitle">
              {item.subtitle}
            </div>
          </Link>
        </Col>
  ...
  render() {
    ...
    return (
      <div id="page1" className="home-page-wrapper page1">
        <div className="home-page">
          <h1 key="h1" className="page1-header"><FormattedMessage id="app.home.features" /></h1>
